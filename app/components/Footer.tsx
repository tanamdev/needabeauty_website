          ...
          <div className="grid md:grid-cols-2 gap-8 items-center">
            <div>
              ...
              <p className="text-gray-400 text-sm">
                Subscribe newsletter kami untuk mendapatkan tips bisnis, update
                produk, dan penawaran eksklusif.
              </p>
            </div>
            <div className="flex flex-col sm:flex-row gap-3">
              ...
              />
              <button className="bg-gradient-to-r from-orange-500 to-orange-600 text-white px-6 py-3 rounded-lg font-medium hover:shadow-lg transition-all duration-200 whitespace-nowrap">
                Subscribe
              </button>
            </div>
          </div>
